...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RCTYouTube/RCTYouTube.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNMusicMetadata/RNMusicMetadata.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNSoundRecorder/RNSoundRecorder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReactNativeAudioToolkit/ReactNativeAudioToolkit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-keep-awake/react_native_keep_awake.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-netinfo/react_native_netinfo.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-orientation-locker/react_native_orientation_locker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-segmented-control/react_native_segmented_control.framework"
