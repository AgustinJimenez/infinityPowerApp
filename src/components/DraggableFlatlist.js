...
import { LayoutAnimation, YellowBox, Animated, FlatList, View, PanResponder, Platform, UIManager, StatusBar, StyleSheet } from 'react-native'
    ...
    this._panResponder = PanResponder.create({
      onStartShouldSetPanResponderCapture: (evt, gestureState) => {
        ...
        if (this.props.scrollingContainerOffset !== undefined) {
          //console.log('offset', this._additionalOffset + this._containerOffset - this.props.scrollingContainerOffset - this._androidStatusBarOffset)
